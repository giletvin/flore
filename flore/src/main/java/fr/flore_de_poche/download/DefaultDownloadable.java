...
public class DefaultDownloadable extends Downloadable {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see fr.flore_de_poche.download.Downloadable#download()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see fr.flore_de_poche.download.Downloadable#getFile()
	 */
	@Override
	public File getFile() {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see fr.flore_de_poche.download.Downloadable#refresh()
	 */
	@Override
	public void refresh() {
		download(true);
